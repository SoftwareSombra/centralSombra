...
class ClienteMissaoChatScreen extends StatefulWidget {
  ...
  State<ClienteMissaoChatScreen> createState() =>
      _ClienteMissaoChatScreenState();
}

class _ClienteMissaoChatScreenState extends State<ClienteMissaoChatScreen> {
  ...
  Future<void> chatController(uid, agenteUid) async {
    _chatController = ChatController(
      ...
      chatCollection: 'Chat missão cliente',
  ...
  void initState() {
    ...
    chatViewController.startListeningForNewChatMissaoClienteMessages();
  ...
  void _onSendTap(
    ...
    await _chatController.sendMessageChatMissaoClienteToFirestore(
      Message(
        id: id.toString(),
