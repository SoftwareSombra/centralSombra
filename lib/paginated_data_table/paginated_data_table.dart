...
class PaginatedDataTable2 extends StatefulWidget {
  ...
  /// should be provided each time a particular [PaginatedDataTable2] widget is
  /// created; avoid creating a new [DataTableSource] with each new instance of
  /// the [PaginatedDataTable2] widget unless the data table really is to now
...
class PaginatedDataTable2State extends State<PaginatedDataTable2> {
  ...
  void reassemble() {
    ...
    // triggering a notification, leaving the PaginatedDataTable2 in an invalid
