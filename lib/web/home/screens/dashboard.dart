...
class _WebLoginHomeState extends State<WebLoginHome> {
  ...
  void initState() {
    ...
    context.read<NotificacaoChatClienteBloc>().add(BuscarNotificacaoChatCliente());
  }
                            ...
                            return FloatingChatButton(
                              ...
                              chatIconWidget: Stack(
                                children: [
                                  ...
                                  notState is NotificacaoLoaded && notClienteState is NotificacaoChatClienteLoaded
                                      ? notState.hasNotification || notClienteState.hasNotification
                                          ? Positioned(
                                              top: 10,
                                              right: 10,
                                              child: Container(
