...
class LoginTexts extends ChangeNotifier {
  ...
  static const String _defaultWelcome = 'SOMBRA';
  static const String _defaultWelcomeDescription = kIsWeb
      ? 'Assessoramento, preservação, acompanhamento de veículos e cargas'
      : 'Gestão em pronta resposta';
  ...
  static const String _defaultWelcomeBack = 'SOMBRA';
