...
class Validators {
  ...
  String? email(String? email) {
    ...
    if (!isValid) {
      const defaultMessage = 'Por favor, insira um e-mail válido.';
  ...
  String? name(String? name) {
    ...
    if (errorMessage == null) {
      ...
      if (!isValid) {
        const defaultMessage = 'Por favor, insira um nome válido.';
  ...
  String? _lengthCheck(String? text, int length) {
    final lengthError = 'Deve conter pelo menos $length caracteres.';
  ...
  String? _upperCaseCheck(String text) {
    ...
    if (!containsUpperCase) {
      const defaultMessage = 'Deve conter uma letra maiúscula.';
  ...
  String? _lowerCaseCheck(String text) {
    ...
    if (!containsLowerCase) {
      const defaultMessage = 'Deve conter uma letra minúscula.';
      return validator?.validatorCallback?.call(text) ?? defaultMessage;
    }
    return null;
  }
  ...
  String? _numberCheck(String text) {
    ...
    if (!containsNumber) {
      const defaultMessage = 'Deve conter um número.';
      return validator?.validatorCallback?.call(text) ?? defaultMessage;
    }
    return null;
  }
  ...
  String? _spaceCheck(String text) {
    ...
    if (containsSpace) {
      const defaultMessage = 'Não deve conter espaços.';
      return validator?.validatorCallback?.call(text) ?? defaultMessage;
    }
    return null;
  }
